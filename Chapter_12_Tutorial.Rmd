...
1. Create a new directory on your computer, then turn it into a local repository  using your computer's command line. Create a remote repository on GitHub with the same name as your  and then push that into GitHub using the terminal (check this!). More detailed instructions are available in (@Gandrud_2020).
