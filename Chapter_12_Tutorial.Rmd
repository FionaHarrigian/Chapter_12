...
First, we need to create a GitHub account. To create a github account, visit [Github](https://github.com/). Register with your BSU valid email address and create an account for free. Good news if you already have git, just login with your details!
# What is Github
...
```{r push_notifications, echo=FALSE, fig.cap="Setting up push notifications", out.width = '100%'}
...
```{r red_green, echo=FALSE, fig.cap="Interface when pushing and committing changes", out.width = '100%'}
