...
```{r pressure, echo=FALSE, fig.cap="Creating a remote repository", out.width = '100%'}
...
```{r pressure, echo=FALSE, fig.cap="Cloning Repository", out.width = '100%'}
...
```{r pressure, echo=FALSE, fig.cap="Interface when pushing and comming" = '100%'}
#what does red and green colours mean when you ar communicating with your collaborator
