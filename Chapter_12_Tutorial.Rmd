...
# 2.2 Activity for Day 2 of the Tutorial
...
*Add your partner by clicking the add people button and searching for your partner’s GitHub account name (check with them, sometimes it may be different from their name, include numbers, etc.)
*Click Add to repository, your partner should get a code in an email to access your repository.
...
Follow the directions to clone your repository in RStudio as presented in section (need to fill in).
...
# 2.3 Import data into R from github repository
