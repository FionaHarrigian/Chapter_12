...
* [Create a remote repository on GitHub](#create-a-remote-repository-on-github)
* Create a project in R studio and (clone?)
...
and then create a remote repository on GitHub clone that repository into your local computer which can then be updated and pushed back into Github. Make sure that the name of your repository matches with the one you will be cloning.
...
### Create a project in RStudio (and clone - or link)
...
```{r introrepo, echo=FALSE, fig.cap="Invitation for collaboration", out.width = '100%'}
...
Follow the directions to clone your repository in RStudio as presented in section \@ref(2.2).
